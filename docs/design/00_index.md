...
| 04-03 | [Model Manager 详细设计](04_components/03_model_manager.md) | 三类模型管理、BaseModel 接口规范 |
| 04-04 | [Trainer Manager 详细设计](04_components/04_trainer_manager.md) | 三类训练器管理、BaseTrainer 接口规范 |
| 04-05 | [Experiment Manager 详细设计](04_components/05_experiment_manager.md) | 控制反转、实验配置语法、评估指标体系 |
